...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/users/projects/myproject/node_modules/yargs/callback.js:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/users/projects/myproject/folder/random.ts:: ["yargs"]
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/users/projects/myproject/node_modules/yargs/index.js:: []
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/users/projects/myproject/some/index.ts:: ["yargs"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 4 Done: ["yargs"]
Info seq  [hh:mm:ss:mss] response:
    {
      "response": [
        {
